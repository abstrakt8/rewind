...
export interface OsuClassicJudgementsSettings extends AnimationTimeSetting, PositionSetting, ScaleSetting {
  ...
  // At time=0ms texture[0], at 17ms texture[1] will be used at 34ms texture[1] will still be used since it's the last one.
  // In case there is no animation just provide a list of one texture.
  textures: Texture[];
